...
export const ThemeToggleButton: React.FC = () => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="p-2 rounded-lg hover:text-[var(--color-brand-primary)] text-[var(--color-text-secondary)] transition-colors"
...
export const CartButton: React.FC = () => {
  ...
  return (
    <>
      <button
        className="relative p-2 ml-4 rounded-lg hover:text-[var(--color-brand-primary)] transition-colors"
        onClick={toggleCart}
